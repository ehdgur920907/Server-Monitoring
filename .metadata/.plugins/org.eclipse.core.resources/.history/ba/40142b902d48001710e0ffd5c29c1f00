					...
					<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css">
						...
						<body>
							<div class="big-chart-div">
								<h1 style="margin-left:650px; color:white;" class="big-chart-title">CPU</h1>
								<div class="big-chart-container">
									<canvas id="cpuChartLine" class="big-chart" width="100" height="100"></canvas>
								</div>
							</div>
						</body>
						<script src="<c:url value=" /resources/js/cpu.js" /"></script>
